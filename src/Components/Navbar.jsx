...
//                             <li className="nav-item"><a className="nav-link active" href="#"><p>Home</p></a></li>
//                             <li className="nav-item"><a className="nav-link" href="#"><p>Explore</p></a></li>
//                             <li className="nav-item"><a className="nav-link" href="#"><p>Travel</p></a></li>
//                             <li className="nav-item"><a className="nav-link" href="#"><p>Blog</p></a></li>
//                             <li className="nav-item"><a className="nav-link" href="#"><p>Pricing</p></a></li>
//                         </ul>
